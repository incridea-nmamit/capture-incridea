...
const MasalaCoffee = () => {
  ...
  const { data, isLoading, error, fetchNextPage, isFetchingNextPage } = api.capture.getApprovedImagesByCategory.useInfiniteQuery({ category: "masalacoffee", includeDownloadCount: session?.user.role === "admin" }, {
