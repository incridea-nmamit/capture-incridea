...
const About = () => {
  ...
  return (
    <>
      ...
      <main className='container-size text-center space-y-24 lg:py-24 md:py-16 py-8'>
        <section>
          <img src="/images/Logo/nitteLogoWhite.png" width={800} height={300} alt="nmamit logo" className='mx-auto px-4' />
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 place-items-center gap-4'>
          ...
          >
            <img src="/images/Logo/incrideaLogo.png" width={800} height={300} alt="capture logo" className='mx-auto max-h-44 max-w-96 w-full h-full' />
          </div>
        ...
        <section className='grid grid-cols-1 lg:grid-cols-2 place-items-center gap-4'>
          ...
          >
            <img src="/images/Logo/capture-main.png" width={800} height={300} alt="capture logo" className='mx-auto max-h-44 max-w-96 w-full h-full' />
          </div>
          <div className=' space-y-4 max-w-xl'>
            <p>Capture Incridea is the official digital platform curated by the Media-Social Media Team of Incridea, the fabulous techno-cultural fest of NMAM Institute of Technology, Nitte. It serves as a repository of thoughtfully captured moments, showcasing the essence of the fest through its stunning captures & engaging stories.</p>

            <p>Capture Incridea features a diverse collection of visuals documenting events, programs, participants, and audience interactions, providing a glimpse of the vibrant & dynamic spirit of Incridea. Capture Incridea aims to preserve and celebrate the fest's most memorable experiences in a artistic manner</p>
          </div>
        </section>
        ...
        <section>
          <h5 className='font-Teknaf text-5xl mb-16'>WE team incredia</h5>
