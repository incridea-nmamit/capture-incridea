      ...
      <AnimatePresence>
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            className="bg-white/10 backdrop-blur-md rounded-3xl p-6 sm:p-8 w-full max-w-4xl pointer-events-auto"
          >
            <motion.h1
              initial={{ scale: 0.9 }}
              animate={{ scale: 1 }}
              transition={{ duration: 0.5, type: "spring" }}
              className="mb-4 sm:mb-6 text-3xl sm:text-5xl md:text-6xl lg:text-8xl font-bold font-Hunters tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-600"
            >
              Captures
            </motion.h1>
            <motion.p
