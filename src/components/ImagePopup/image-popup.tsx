...
const ImagePopup: React.FC<ImagePopupProps> = ({
    ...
    return (
        ...
        >
            <div
                className="  overflow-scroll   md:w-auto max-h-[98vh]  w-full h-full bg-neutral-950 grid grid-cols-1 gap-4 rounded-3xl  p-4 md:p-8"
                onClick={(e) => e.stopPropagation()}
            >
                {/* Category Name Block */}
                <div className="text-center">
                    <h4 className="font-Teknaf text-3xl md:text-4xl bg-white rounded-md text-neutral-900 p-2 inline-block">
                        Category Name
                    </h4>
                </div>
                ...
                {/* Footer Section */}
                <div className="text-center">
                    <p className="text-xs sm:text-sm mx-auto max-w-lg mb-4 text-white">
                        Note: If you prefer this capture not to be public or have any issues. We’ll verify your request and work on it soon.
                    </p>
                    <button
