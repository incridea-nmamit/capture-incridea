...
const CapturePopup: React.FC<CapturePopupProps> = ({
  ...
  return (
    ...
    >
      <div
        className="max-w-[90vw] max-h-[98vh] w-full h-full grid grid-cols-1 md:grid-cols-2 bg-neutral-950 gap-4 rounded-3xl overflow-hidden"
      ...
      >
        ...
        <div className="md:hidden flex items-center justify-center p-0 md:p-4">
          <Image
        ...
        <div className="hidden md:flex items-center justify-center p-0 md:p-4">
          <Image
            src={selectedImage || "/images/fallback.jpg"}
            alt="Selected"
            className="rounded-lg"
