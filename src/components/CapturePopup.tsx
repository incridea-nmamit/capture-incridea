        ...
        <div className="flex flex-col justify-between">
          ...
          <div>
            <div className="text-center py-5 m-4">
              ...
              <button className="flex-grow bg-white rounded-2xl text-black p-2 px-5 hover:scale-105 transition-all" onClick={() => {
                handleClosePopup();
            ...
            <span className="flex items-center">{totalLikes !== null ? totalLikes : "..."}</span>
              ...
              <button className="flex-grow bg-white rounded-2xl text-black mx-10 p-2 px-6 hover:scale-[101%] transition-all" onClick={() => handleDownload(selectedImageOg || selectedImage)}>
                Download
              </button>
            </div>
          </div>
