...
const TeamCard: React.FC<CardProps> = ({
  ...
  return (
    <div className="relative w-72 md:w-80 bg-gradient-to-b from-neutral-900 via-neutral-800 to-neutral-900 rounded-3xl p-4 md:p-6  border hover:shadow-xl transform transition-transform duration-300 hover:scale-105  ">
