...
function About() {
    return (
        <section className="container-size mx-auto flex flex-col items-center justify-center text-center h-screen gap-8">
            <h3 className='mb-8 w-full font-Teknaf text-5xl md:text-6xl lg:text-6xl text-center'>We capture what u see....</h3>

            <p className="max-w-3xl text-center font-Trap-Regular">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has b
