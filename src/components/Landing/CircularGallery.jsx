...
class App {
  ...
  update() {
    ...
    const scrollCurrent = Math.round(this.scroll.current * 100)/100
    const direction = scrollCurrent > this.scroll.last ? 'right' : 'left'

    // console.log(direction, scrollCurrent ,this.scroll.last);
    ...
    this.scroll.last = scrollCurrent
